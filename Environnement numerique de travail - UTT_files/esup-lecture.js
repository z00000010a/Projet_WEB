...
// Custom menu UTT
        $(parentID + ".displaycat").hide();

        $(parentID + ".displaycat-toggle").click(function () {
            $(".displaycat").slideToggle();
        });

// Custom Cats UTT
//        $(parentID + ".catsubtitle").click(function () {
 //           $(this).
...
//resize
		...
		function closeNews(p) {
            ...
            // Custom UTT
            div.children(".resumeArticle").children(".article-block").children("a").show();
		}
